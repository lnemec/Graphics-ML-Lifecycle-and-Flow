...
\begin{document}
	...
	\begin{tikzpicture}[node distance = 2cm,
		...
		\node [block, left of= N4, yshift=-1.0cm] (feature) {Feature Engineering};
		\node [block, right of = N4, yshift=-1.0cm](annotate) {Data Annotation};
		...
		\path [line, dashed, draw=mediumgrey] ($(annotate.east) + (1.5cm,0) $) -- node[yshift=0.5cm] {} (annotate.east);
